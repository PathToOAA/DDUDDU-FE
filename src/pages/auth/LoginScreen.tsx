  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f5f6f4] px-6">
      <section className="w-full max-w-[430px] rounded-3xl bg-white px-6 py-12 text-center shadow-sm">
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-[#16883b] text-4xl text-white">🚶</div>
        ...
        <button type="button" onClick={loginWithKakao} disabled={isLoading} className="mt-10 flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-[#fee500] font-semibold text-[#191919] disabled:opacity-60"><span className="text-xl">💬</span>{isLoading ? "카카오 로그인 중..." : "카카오로 시작하기"}</button>
